                        ...
                        <SideNav
                            onSelect={(selected) => {
                                ...
                                if (!route) {
                                    ...
                                    switch (to) {
                                        case "/addInfo/point":
                                            localInfo.addInfoOnMap ? setAddInfo(false) : setAddInfo(true);
                                            break;
                                        case "/addInfo/direction":
                                            localInfo.addRoadOnMap ? setAddRoad(false) : setAddRoad(true);
                                            break;
                                        case "/bookMark/addBookmark":
                                            localInfo.addBookMark ? setAddBookMark(false) : setAddBookMark(true);
                                            break;
                                    }
                                }
                            }}
...
export default withRouter(SideBarContainter);
