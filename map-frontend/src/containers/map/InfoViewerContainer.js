...
const InfoViewerContainer = () => {
    ...
    const {placeInfo} = useSelector(({map}) => ({
                ...
                <Row>
                    <Col>
                        <div style={{width: 500, height: 400}}>
                            <CarouselContainer info={placeInfo}/>
                        </div>
                    </Col>
                    <Col>
                        <div style={{width: 450, height: 400, paddingBottom: 20}}>
                            ...
                            {localInfo.visibleOnTabPosition && <BasicInfoViewerContainer info={placeInfo}/>}
                            {localInfo.visibleOnTabEstimate && <EstimateContainer info={placeInfo}/>}
                            {localInfo.visibleOnTabComment &&
                            <CommentContainer info={placeInfo} setUpdateCommentList={updateComment}/>}
                        </div>
                    </Col>
                </Row>
            </div>
